...
export function SavingsAccountForm({ account, onSuccess }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (isEdit) {
                await updateSavingsAccount(account.id, payload);
            } else {
    ...
    return (
        <div className="portfolio-form">
            <h3>{isEdit ? t('portfolioForm.editSavingsAccount') : t('portfolioForm.addSavingsAccount')}</h3>
